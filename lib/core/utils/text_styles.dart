...
TextStyle poppins14W400() => GoogleFonts.poppins(
    fontSize: 14.sp, fontWeight: FontWeight.w400, color: AppColors.hintColor);

TextStyle poppins12W400() => GoogleFonts.poppins(
    fontSize: 12.sp, fontWeight: FontWeight.w400, color: AppColors.hintColor);

TextStyle poppins18W500() => GoogleFonts.poppins(
    fontSize: 18.sp, fontWeight: FontWeight.w500, color: AppColors.hintColor);

TextStyle poppins20W500() => GoogleFonts.poppins(
  fontSize: 20.sp, fontWeight: FontWeight.w500 , color: AppColors.hintColor);